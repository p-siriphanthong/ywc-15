...
<body data-spy="scroll" data-target=".menu">
	...
	<nav class="menu navbar-fixed-top">
  		<ul class="nav">
    		<li><a href="#search"><i class="glyphicon glyphicon-search" aria-hidden="true"></i></a></li>
    		<li><a href="#interviewee"><i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i></a></li>
    		<li><a href="#homework"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></li>
    		<li><a href="#briefcase"><i class="glyphicon glyphicon-briefcase" aria-hidden="true"></i></a></li>
    		<li><a href="#travel"><i class="fa fa-car" aria-hidden="true"></i></a></li>
    		<li><a href="#contact"><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i></a></li>
    	</ul>
	</nav>
	...
	<div id="interviewee" class="page interviewee-page">
		<div class="page-content">
			<ul id="nav-tabs" class="nav nav-tabs" role="tablist"></ul>
